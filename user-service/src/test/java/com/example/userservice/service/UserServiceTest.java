...
//        // Set the userDeletedTopic field value
//        var topicField = UserService.class.getDeclaredField("userDeletedTopic");
//        topicField.setAccessible(true);
//        topicField.set(userService, "user.deleted");
//    }
//
//    // -----------------------
//    // create tests
...
//    // -----------------------
//    @Test
//    void delete_Success_SendsKafkaMessageAndDeletesUser() {
//        // Arrange
//        User admin = new User();
//        admin.setId(actorAdminId);
//        admin.setRole(UserRole.ROLE_ADMIN);
...
//                .thenReturn(Flux.just(mockSenderResult));
//
...
//
//    @Test
//    void delete_KafkaSendFails_DeletionAborted() {
//        // Arrange
//        User admin = new User();
//        admin.setId(actorAdminId);
//        admin.setRole(UserRole.ROLE_ADMIN);
...
//        when(userRepository.findById(testUserId)).thenReturn(Mono.just(userToDelete));
//
//        // Mock KafkaSender to return a SenderResult with exception
...
//                                    throwable.getMessage().contains("Failed to send Kafka message for user"))
//                    .verify();
//
//            // Verify userRepository.delete was NOT called
//            verify(userRepository, never()).delete(any(User.class));
//        }
//    }
//
//    @Test
//    void delete_KafkaSendFluxError_DeletionAborted() {
//        // Arrange
//        User admin = new User();
//        admin.setId(actorAdminId);
//        admin.setRole(UserRole.ROLE_ADMIN);
...
//        when(userRepository.findById(testUserId)).thenReturn(Mono.just(userToDelete));
//
//        // Mock KafkaSender to return Flux with error
//        when(kafkaSender.send(any(Mono.class)))
...
//
//    @Test
//    void delete_UserNotFound_ThrowsNotFound() {
//        // Arrange
//        User admin = new User();
//        admin.setId(actorAdminId);
//        admin.setRole(UserRole.ROLE_ADMIN);
...
//                    .verify();
//
//            // Verify no Kafka message sent and no deletion
