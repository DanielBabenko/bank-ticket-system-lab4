...
@Service
@Transactional
public class CreateTagUseCaseTransactionalDecorator implements CreateTagUseCasePort {

    private final CreateTagUseCase delegate;

    public CreateTagUseCaseTransactionalDecorator(TagRepositoryPort tagRepositoryPort) {
