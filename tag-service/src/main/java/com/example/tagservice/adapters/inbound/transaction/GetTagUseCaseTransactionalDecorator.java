...
public class GetTagUseCaseTransactionalDecorator implements GetTagUseCasePort {

    private final GetTagUseCase delegate;

    public GetTagUseCaseTransactionalDecorator(TagRepositoryPort tagRepositoryPort) {
