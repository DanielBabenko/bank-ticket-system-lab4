package com.example.assignmentservice.infrastructure.persistence;
...
@Repository
public interface UserProductAssignmentJpaRepository extends JpaRepository<UserProductAssignment, UUID> {
