    ...
    public SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity http, ReactiveJwtDecoder jwtDecoder) {
        ...
        return http
                ...
                .authorizeExchange(auth -> auth
                        ...
                        .pathMatchers("/api/v1/applications/internal/by-user", "/api/v1/applications/internal/by-product", "/api/v1/applications/by-tag", "/api/v1/applications/by-file").permitAll()
