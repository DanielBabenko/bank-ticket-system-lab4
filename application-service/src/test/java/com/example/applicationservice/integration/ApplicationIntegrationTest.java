...
public class ApplicationIntegrationTest {
    ...
    static void configureProperties(DynamicPropertyRegistry registry) {
        ...
        // Kafka properties for testing - using embedded or mock
    ...
    void addTags_asApplicant_shouldReturnNoContent() {
        ...
        Application updatedApp = applicationRepository.findByIdWithTags(app.getId()).orElseThrow();
        assertTrue(updatedApp.getTags().contains("urgent"));
        assertTrue(updatedApp.getTags().contains("verified"));
    }
    ...
    void removeTags_asApplicant_shouldReturnNoContent() {
        ...
        Application updatedApp = applicationRepository.findByIdWithTags(app.getId()).orElseThrow();
        assertFalse(updatedApp.getTags().contains("urgent"));
        assertTrue(updatedApp.getTags().contains("verified"));
    }
    ...
    @Test
    void createApplication_adminCreatesForOtherUser_shouldReturnCreated() {
        ApplicationRequest request = new ApplicationRequest();
        request.setApplicantId(anotherApplicantId);
        request.setProductId(productId);
        ...
        assertEquals(HttpStatus.CREATED, response.getStatusCode());
        assertNotNull(response.getBody());
        assertEquals(anotherApplicantId, response.getBody().getApplicantId());
    }

    @Test
    void createApplication_clientCreatesForOtherUser_shouldReturnForbidden() {
        ApplicationRequest request = new ApplicationRequest();
        request.setApplicantId(anotherApplicantId);
        request.setProductId(productId);
